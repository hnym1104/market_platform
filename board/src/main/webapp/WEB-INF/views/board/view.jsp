						...
						<tbody>
							<c:forEach items="${reply}" var="reply">
								<tr>
									...
									<td class="tg-0lax"
										...
										onFocus="this.value='비밀번호'; return true;" /> <input type="hidden"
								...
								<tr>
									<td class="tg-0lax"
										style="border-top: none; border-right: none; border-bottom: none;">${reply.repContent}&#32;&#40;<fmt:formatDate
											value="${reply.repDate}" pattern="yyyy.MM.dd kk:mm" />&#41;
									</td>
									<td class="tg-0lax" colspan="2" style="border: none;"></td>
									<td class="tg-0lax"
							...
							<tr style="border: none;">
								<td class="tg-0lax"
									...
									type="text" name="repWriter" value="이름"
									onFocus="this.value=''; return true;" /><input type="hidden"
									name="gdsNum" value="${view.gdsNum}"></td>
								<td class="tg-0lax" colspan="2" rowspan="2"
									style="border-left: none; border-top: none; border-right: none;"><input
									type="text" name="repContent" value="내용" size="80"
									style="height: 50px" onFocus="this.value=''; return true;" /></td>
							...
							<tr style="border: none;">
								<td class="tg-0lax"
									...
									type="text" name="repPwd" value="비밀번호"
